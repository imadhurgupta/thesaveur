...
def get_email_template(heading, body_content, banner_color_start="#2D5016", banner_color_end="#3A661D", footer_note=None):
    """
    ...
    note_text = footer_note if footer_note else "You received this automated notification regarding your account or order on The Saveur."
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #FAF7F2; padding: 24px 12px; margin: 0; color: #222222; -webkit-font-smoothing: antialiased;">
    <div style="max-width: 580px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; border: 1px solid #EAE6DF; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.03);">
        ...
        <div style="background-color: {banner_color_start}; padding: 24px 20px; text-align: center; color: #ffffff;">
            ...
            <div style="font-size: 11px; opacity: 0.9; margin-top: 4px; letter-spacing: 0.5px;">Pure &bull; Natural &bull; Trusted</div>
        </div>

        <!-- Main Body -->
        <div style="padding: 30px 26px; line-height: 1.6;">
        ...
        <div style="background-color: #FAF7F2; padding: 20px 24px; text-align: center; font-size: 12px; color: #666666; border-top: 1px solid #EAE6DF; line-height: 1.5;">
            ...
            <p style="margin: 0 0 8px 0; font-size: 11px; color: #777777;">{note_text}</p>
